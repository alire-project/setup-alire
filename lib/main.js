...
function detect_cached(version, branch) {
    return __awaiter(this, void 0, void 0, function* () {
        const ext = (process.platform == "win32" ? ".exe" : "");
        const alr_path = path_1.default.join(process.cwd(), install_dir, "bin", `alr${ext}`);
        if (!fs_1.default.existsSync(alr_path)) {
        ...
        function reinstall(reason) {
            ...
            fs_1.default.rmSync(path_1.default.join(process.cwd(), install_dir), { recursive: true, force: true });
            return false;
        }
        ...
        var output = "";
        try {
            yield exec.exec(alr_path, ["--version"], {
                listeners: {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const cached = yield detect_cached(version, branch);
            if (!cached) {
                if (branch.length == 0) {
